...
// AsyncTask 3rd Value is String[], so we Use the Callbacks as String[]
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int ID_LOADER_FORECAST = 100;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle args = null;
        getSupportLoaderManager().initLoader(ID_LOADER_FORECAST, args, this);
    }
...
//        new FetchWeatherTask().execute(location);
    ...
    public Loader<String[]> onCreateLoader(int id, Bundle args) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            // Need this to pass the data to deliverResult & onStartLoading
            String[] theData = null;
...
//            loadWeatherData();
            getSupportLoaderManager().restartLoader(ID_LOADER_FORECAST, null, this);
            return true;
        }
